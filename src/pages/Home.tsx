            ...
            <div className="text-center mb-16">
              <div className="flex justify-center mb-8">
                <div className="relative">
                  ...
                  <img src={treeLogo} alt="Go Green" className="h-24 w-24 relative z-10 animate-gentle-bounce" />
                </div>
              </div>
                ...
                <CardContent className="p-10 text-center h-full flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-6 rounded-2xl overflow-hidden shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                      <img src={communityEco} alt="Community" className="w-full h-40 object-cover group-hover:scale-105 transition-transform duration-500" />
                    </div>
                    <p className="text-muted-foreground leading-relaxed text-lg">
